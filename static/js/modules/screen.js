define(['underscore', 'gamejs', 'modules/globals', 'gamejs/utils/vectors'], function(_, gamejs, globals, $v) {
     ...
     */
    var audioOver = new Audio('static/sound/gameover.ogg');
    var audioPause = new Audio('static/sound/pause.ogg');
    var draw = function(display, world) {
        if (world.gameOver) { // draw the gameover screen
            ...
            display.blit(fonts.small.render('Pontuação', '#FFFFFF'), [globals.game.screenSize[0] / 2 - 150, globals.game.screenSize[1] / 2 - 36]);
            display.blit(fonts.small.render('Distancia', '#FFFFFF'), [globals.game.screenSize[0] / 2 - 150, globals.game.screenSize[1] / 2]);
            display.blit(fonts.small.render('Precisão', '#FFFFFF'), [globals.game.screenSize[0] / 2 - 150, globals.game.screenSize[1] / 2 + 36]);
        ...
        if (world.paused) { // draw the pause screen
            ...
            var esc   = fonts.small.render('Precione ESC para continuar', '#FFFFFF');
    ...
    var init = function() {
        ...
        texts = {
            ...
            // powerups
            branching: fonts.small.render('Ramifica seu laser!', '#FFFFFF'),
            cloning:   fonts.small.render('Clona uma nova vida!', '#FFFFFF'),
            forking:   fonts.small.render('Dupla munição!', '#FFFFFF'),
            pulling:   fonts.small.render('Novos poderes!', '#FFFFFF'),
            pushing:   fonts.small.render('Acabe com seus inimigos!', '#FFFFFF'),
            stashing:  fonts.small.render('Novo Misil!', '#FFFFFF')
        };
    };
